        ...
        <div className="container shadow bg-light rounded text-dark d-flex flex-l-row flex-column p-5 my-5">
          <div className="d-flex flex-column flex-xl-row  align-items-center justify-content-between ">
            <div className="d-flex flex-column">
              <h3 className="h3">
                {advertise.type} <small>at</small> {advertise.address}
              </h3>
              <h6>
                Available for <span> {advertise.sorr}</span>
              </h6>
              ...
              <span className="display-6">
                Size {advertise.size}{" "}
                <span className="badge bg-warning p-1"> Sq Feet</span>
              </span>
              {furniture}
            </div>
            <div className="">
              <img
                width="400px"
                alt="Property"
                src="https://source.unsplash.com/260x160/?house,flat"
              />
            </div>
          </div>
          ...
          <div className="d-flex flex-column">
            <p className="h3">
              Owner <span className="display-5 ">{advertise.owner}</span>
            </p>
            <h6>
              Owner Contact: <span>{advertise.ownercontact}</span>
            </h6>
          </div>
