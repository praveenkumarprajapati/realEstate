...
const AllAdvertisements = ({ advertisements }) => {
  return (
    <div
      className="container-fluid d-flex flex-column align-items-center justify-content-center bg-secondary p-5 text-light"
      id="allAdd"
    >
            ...
            <div className="card p-3 m-2">
              <div className="card-body">
                ...
                <h6 className="card-subtitle">
                  {prop.type} At{" "}
                  <span className="card-text badge bg-success">
                    {prop.address}
                  </span>
                </h6>
                <h3 className="card-title">{prop.sorr}</h3>
                <p>
                  <span className="display-6"> &#8377;</span> {prop.price} .00{" "}
                </p>

                <Link
                  to={`/showAdvertisement/${prop._id}`}
